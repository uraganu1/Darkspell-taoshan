...
HOSTCC       = ccache gcc
HOSTCXX      = ccache g++
HOSTCFLAGS   = -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -pipe -DNDEBUG 
...
CFLAGS_MODULE   = $(GRAPHITE) -fno-pic -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
